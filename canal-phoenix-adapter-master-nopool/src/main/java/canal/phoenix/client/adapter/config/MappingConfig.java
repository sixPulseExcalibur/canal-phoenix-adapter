...
public class MappingConfig {
    ...
    private boolean debug = false;          // 调试   增加一个debug
    ...
    public static class DbMapping {
        ...
        private boolean alter = true;                       // 是否允许修改表     新增
        private boolean drop = false;                       // 是否允许删除字段   新增
        private boolean limit = false;                      // 是否限制字段长度   新增
        private boolean skipMissing = false;                // 是否跳过丢失的字段 新增
        private boolean escapeUpper = true;                 // 字段默认大写加双引号  新增

        private String targetDb;                            // 目标库名
        private String targetTable;                         // 目标表名
        private Map<String, String> targetColumns;          // 目标表字段映射

        private List<String> excludeColumns;                // 不映射的字段  新增
